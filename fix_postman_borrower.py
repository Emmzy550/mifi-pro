...
# Target Org from your server log (The one your KEY belongs to)
ORG_ID = "ORG-D502E912"

new_borrower = Borrower(
    id=f"BOR-{uuid.uuid4().hex[:8].upper()}",
    organization_id=ORG_ID,
    name="Postman Key Match User",
    phone="+260970000000",
    ...
    loan_purpose="Testing API Key Match"
)

Database.save_borrower(new_borrower)
print(f"\nSUCCESS! Created borrower for Key's Org: {ORG_ID}")
